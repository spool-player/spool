    ...
    foreach(index RANGE 0 ${last})
        ...
        if(override)
            ...
            foreach(source IN LISTS sources)
                ...
                set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${override}/${source}")
            endforeach()
        else()
        ...
        foreach(file IN LISTS files)
            ...
            file(SHA256 "${root}/${file}" file_digest)
            string(APPEND digest "${id}/${file}:${file_digest}\n")
        endforeach()
